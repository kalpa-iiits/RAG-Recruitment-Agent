...
def display_analysis_results(analysis_result):
    ...
    st.markdown(
        ...
        'margin-bottom: 10px;">Powered by AI Recruitment</div>',
        unsafe_allow_html=True,
    )
    ...
    with col2:
        report_content = f"""# AI Recruitment - Resume Analysis Report
        ...
        href = (
            ...
            f'download="ai_resume_analysis.txt">📊 Download Analysis Report</a>'
        )
